...
<div class="content wrapper">
  <div class="container-fluid">
    <div class="row">
      ...
      <div class="col-md-12">
        <div class="card">
          <div class="header">Daftar Resep</div>
          <div class="content">
            <div class="toolbar">
             <a href="<?php echo base_url('index.php/c_produk/formTambahProduk'); ?>" class="btn btn-primary" type="button">Tambah Resep</a>
           </div>
           <br>
            ...
            <table  id="example1" class="table table-hover table-striped">
              ...
              <tbody>
                ...
                foreach ($produk as $row){
                  ...
                  <td class="text-right">
                    <a class="btn btn-simple btn-info btn-icon table-action view" rel="tooltip" title="Lihat"  href="<?php echo base_url('index.php/c_produk/tambahresep/'.$row['idroti']); ?>"><i class="fa fa-image"></i></a>
