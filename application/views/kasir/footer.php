...
$(document).ready(function(){
  ...
  $("input[name='bayar']").on("keyup change paste", function() {
    cek();          
  });
  function cek(){
    var total=parseInt($("input[name='total_harga']").val());
    var bayar=parseInt($("input[name='bayar']").val());

    if(bayar < total){
      $("input[name='bayar']").css("border-color",'red');
      $("#submit").attr("disabled","true");

    }else{
      $("input[name='bayar']").css("border-color",'green');
