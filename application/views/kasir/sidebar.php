...
<head>
  ...
  <script type="text/javascript">
    ...
    function Hitung(){
        var a = document.form2.bayar.value;
        var b = document.form2.total_harga.value;
        document.form2.kembalian.value=a-b;
  ...
  <div class="wrapper">
    ...
    <div class="sidebar-wrapper">
      ...
      <ul class="nav">
        ...
        <li>
          <a href="<?php echo base_url(); ?>index.php/c_pemesanan/pemesanan">
